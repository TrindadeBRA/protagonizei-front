      ...
      .refine(
        async (files) => {
          ...
          if (file.type === 'application/pdf') {
            try {
              // Lê os primeiros 5 bytes do arquivo para verificar o cabeçalho PDF
          ...
          // Aceita outros tipos de arquivo permitidos
          const validTypes = [
            'application/pdf',
            'application/msword',
        ...
        'Arquivo inválido ou corrompido. Use PDF, DOC ou DOCX válidos'
      ),
})
