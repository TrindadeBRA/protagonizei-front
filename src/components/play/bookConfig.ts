...
export const BOOK_PAGES = [
	...
	{ id: 'page4', src: '/assets/images/book/page4-1.webp', priority: true },
	{ id: 'page5', src: '/assets/images/book/page5-1.webp', priority: true },
	{ id: 'page6', src: '/assets/images/book/page6-1.webp', priority: true },
	{ id: 'page7', src: '/assets/images/book/page7-1.webp', priority: true },
	{ id: 'page8', src: '/assets/images/book/page8-1.webp', priority: true },
	{ id: 'page9', src: '/assets/images/book/page9-1.webp', priority: true },
	{ id: 'page10', src: '/assets/images/book/page10-1.webp', priority: true },
] as const;
