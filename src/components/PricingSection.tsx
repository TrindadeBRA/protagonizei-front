...
const PricingSection = () => {
    return (
        <section className="pt-16 pb-20 relative overflow-hidden bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50">
            <div className="container mx-auto px-4 relative z-10">
                {/* Header - Copy Otimizada */}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="bg-white rounded-3xl shadow-2xl border border-gray-200 overflow-hidden" data-aos="fade-up">
                        ...
                        {/* Benefits Section - 3 Colunas (Menos Altura) */}
