...
import { BookPage, FlipBookWrapper, FullscreenWidget } from '../../src/components/play';
...
export default function PlayPage() {
	...
	// Controlar overflow do body para experiência de tela cheia
	useEffect(() => {
	...
	return (
		<div className="fixed inset-0 bg-gradient-to-br from-pink-100 via-purple-100 to-blue-100 flex items-center justify-center overflow-hidden z-50 p-10">
			<FullscreenWidget />
