          ...
          <div className="bg-white/60 backdrop-blur-sm rounded-3xl p-6 md:p-8 lg:p-10 shadow-lg">
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-pink-50 rounded-xl p-5 border-l-4 border-blue-main" data-aos="fade-up" data-aos-delay={200}>
                ...
                <ol className="space-y-2 text-gray-700 text-base leading-relaxed ml-7">
                  <li className="flex items-start gap-2">
                    ...
                    <span>Siga o perfil <a href="https://instagram.com/protagonizei.app" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-semibold underline">@protagonizei.app</a> no Instagram</span>
                  </li>
                  <li className="flex items-start gap-2">
              ...
              <div className="bg-gradient-to-r from-blue-50 to-pink-50 rounded-xl p-5 border-l-4 border-blue-main" data-aos="fade-up" data-aos-delay={400}>
                ...
                <p className="text-gray-700 text-base leading-relaxed ml-7">
                  O vencedor será escolhido de forma aleatória. O anúncio será feito por DM no Instagram e/ou pelos Stories da <a href="https://instagram.com/protagonizei.app" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-700 font-semibold underline">@protagonizei.app</a>.
                </p>
              </div>
